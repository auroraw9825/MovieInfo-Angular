...
@Component({
  selector: 'app-trending-movies-cards',
  templateUrl: './trending-movies-cards.component.html',
  styleUrls: ['./trending-movies-cards.component.css']
})

export class TrendingMoviesCardsComponent {
  paused = false;
