...
export class MovieCastComponent implements OnInit {
  ...
  fetchCast(){
    this.postsService.getMovieCast(this.id).subscribe(res =>{ // id is the movie id
        this.movieCast = res;
      ...
      <div *ngIf="small==true">
        ...
        <div style="margin-left:10px; width:340px;">
          ...
          <div class="row">
            ...
            <div *ngIf="ins_id!=''">
              <a href="{{ins_id}}" target="_blank" style="margin-left:10px;" ngbPopove="Visit Instagram" triggers="mouseenter:mouseleave">
                <i class="fa fa-instagram" style="font-size:30px; color: #990099;"></i>
              </a>
            </div>
            <div *ngIf="fb_id!=''">
              <a href="{{fb_id}}" target="_blank" style="margin-left:10px;" ngbPopove="Visit Facebook" triggers="mouseenter:mouseleave">
                <i class="fa fa-facebook-square" style="font-size:30px; color: #blue;"></i>
              </a>
            </div>
            <div *ngIf="twitter_id!=''">
              <a href="{{twitter_id}}" target="_blank" style="margin-left:10px;" ngbPopove="Visit Twitter" triggers="mouseenter:mouseleave">
                <i class="fa fa-twitter" style="font-size:30px; color: #deepskyblue;"></i>
              </a>
            </div>
          </div>
